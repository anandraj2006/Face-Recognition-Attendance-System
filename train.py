...
class Train:
    def __init__(self, root):
        ...
        img4=Image.open(r"C:\Users\KIIT0001\OneDrive\Desktop\Face recognition system\pictures\traindata1.jpeg")
        img4=img4.resize((350,350),Image.LANCZOS)
        self.photoimage4=ImageTk.PhotoImage(img4)
        
        # f_label4 = Label(bg_img, image=self.photoimage4, bd=0, highlightthickness=0)
        # f_label4.place(x=450, y=100)
        ...
        # Save reference of button so we can disable/enable
    ...
    def start_training(self):
        ...
        # Show progress bar & status label NOW
    ...
    def train_classifier(self):
        try:
            ...
            for image_name in image_files:
                ...
                self.root.after(
                    0,
                    lambda p=progress_percent: self.update_progress(p)
                )
    ...
    def training_done(self, total_faces):
        ...
        # Hide progress bar and status after completion
        self.progress.place_forget()
        self.status_label.place_forget()
