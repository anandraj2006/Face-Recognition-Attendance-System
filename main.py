...
from facerecogniton import FaceRecognition
...
class Face_Recognition_System:
    def __init__(self,root):
        ...
        # student button
        img4=Image.open(r"C:\Users\KIIT0001\OneDrive\Desktop\Face recognition system\pictures\student.jpeg")
        ...
        b1_1=Button(bg_img,text="Student",cursor="hand2",font=("times new roman",12,"bold"),bg="royalblue3",fg="white",command=self.student_data)
        b1_1.place(x=150,y=230,width=150,height=35)

        # face recognition button 
        img5=Image.open(r"C:\Users\KIIT0001\OneDrive\Desktop\Face recognition system\pictures\face_recognition.jpeg")
        ...
        b2_1=Button(bg_img,text="Face Recognition",cursor="hand2",font=("times new roman",12,"bold"),bg="royalblue3",fg="white",command=self.face_recognition)
        b2_1.place(x=410,y=230,width=150,height=35)

        # attandance
        img6=Image.open(r"C:\Users\KIIT0001\OneDrive\Desktop\Face recognition system\pictures\attandance.jpeg")
        ...
        b3_1=Button(bg_img,text="Attendance",cursor="hand2",command=self.attendance_data,font=("times new roman",12,"bold"),bg="royalblue3",fg="white")
        b3_1.place(x=670,y=230,width=150,height=35)

        # helpdesk
        img7=Image.open(r"C:\Users\KIIT0001\OneDrive\Desktop\Face recognition system\pictures\helpdesk.jpeg")
        ...
        b4_1=Button(bg_img,text="Help Desk",cursor="hand2",font=("times new roman",12,"bold"),bg="royalblue3",fg="white",command=self.helpdesk)
        b4_1.place(x=930,y=230,width=150,height=35)

        # train data
        img8=Image.open(r"C:\Users\KIIT0001\OneDrive\Desktop\Face recognition system\pictures\traindata.jpeg")
        ...
        b5_1=Button(bg_img,text="Train Data",cursor="hand2",command=self.train_data,font=("times new roman",12,"bold"),bg="royalblue3",fg="white")
        b5_1.place(x=150,y=440,width=150,height=35)

        # photos
        img9=Image.open(r"C:\Users\KIIT0001\OneDrive\Desktop\Face recognition system\pictures\photos.jpeg")
        ...
        b6_1=Button(bg_img,text="Photos",cursor="hand2",font=("times new roman",12,"bold"),bg="royalblue3",fg="white")
        b6_1.place(x=410,y=440,width=150,height=35)

        # developer
        img10=Image.open(r"C:\Users\KIIT0001\OneDrive\Desktop\Face recognition system\pictures\developer.jpeg")
        ...
        b7_1=Button(bg_img,text="Developer",cursor="hand2",font=("times new roman",12,"bold"),bg="royalblue3",fg="white")
        b7_1.place(x=670,y=440,width=150,height=35)

        # exit button
        img11=Image.open(r"C:\Users\KIIT0001\OneDrive\Desktop\Face recognition system\pictures\exit.jpeg")
        ...
        b8_1=Button(bg_img,text="Exit",cursor="hand2",font=("times new roman",12,"bold"),bg="royalblue3",fg="white",command=self.exit_app)
        b8_1.place(x=930,y=440,width=150,height=35)
        
        # b8_1.bind("<Enter>", lambda e: b8_1.config(bg="darkblue"))
        # b8_1.bind("<Leave>", lambda e: b8_1.config(bg="royalblue3"))  later add thid effect to all buttons 
    ...
    def exit_app(self):
        confirm = messagebox.askyesno("Exit System", "Are you sure you want to exit?")
        if confirm:
            self.root.destroy()
